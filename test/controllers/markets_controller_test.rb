...
class MarketsControllerTest < ActionController::TestCase
  ...
  test "should create market" do
    assert_difference('Market.count') do
      post :create, market: { avgPrice: @market.avgPrice, currentDate: @market.currentDate, maxPrice: @market.maxPrice, minPrice: @market.minPrice, name: @market.name, place: @market.place, unit: @market.unit }
    end
  ...
  test "should update market" do
    patch :update, id: @market, market: { avgPrice: @market.avgPrice, currentDate: @market.currentDate, maxPrice: @market.maxPrice, minPrice: @market.minPrice, name: @market.name, place: @market.place, unit: @market.unit }
    assert_redirected_to market_path(assigns(:market))
  end
